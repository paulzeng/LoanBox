package com.xdroid.loanbox.widgets;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public void setRightText(String rightText,OnClickListener rightOnclick){
        if (!TextUtils.isEmpty(rightText)) {
            ...
            rightTextView.setTextColor(UIUtils.getColor(R.color.white));
    ...
    private void initSearchView(){
        ...
        searchText.setCompoundDrawablesWithIntrinsicBounds(R.drawable.icon_search_white,0,0,0);
        searchText.setCompoundDrawablePadding(mOutPadding);
        searchText.setTextColor(UIUtils.getColor(R.color.white));
        searchText.setBackgroundResource(R.drawable.bg_searchview);
        searchText.setHeight(mSearchHeight);
        searchText.setText("What service are you looking for ?");
    ...
    public void setTitleHome(CharSequence title) {
        searchText.setVisibility(View.GONE);
    ...
    public void setTitleColor(int resid) {
        mCenterText.setTextColor(UIUtils.getColor(resid));
    }
     ...
     * @param rightOnclick
     */
    public void setSearchTitle(int leftId,int rightId,final OnClickListener leftOnclick, final OnClickListener rightOnclick, final OnClickListener searchOnclick){
        //隐藏不需要的控件
        mCenterText.setVisibility(View.GONE);
        mSubTitleText.setVisibility(View.GONE);
        mLeftText.setVisibility(View.VISIBLE);
        searchText.setOnClickListener(searchOnclick);
    ...
    public void setTitle(int leftId, String leftText, String centerText, int rightId, String rightText,
        ...
        if (!TextUtils.isEmpty(rightText)) {
            ...
            rightTextView.setTextColor(UIUtils.getColor(R.color.second_text_color));
            if ((Integer) rightId != null) {
